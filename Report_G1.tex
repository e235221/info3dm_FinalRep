...
% 画像ファイルを検索するディレクトリを指定: images/から画像を参照
\graphicspath{ {images/} }
%================================
%Grad-Camに統一して記載
%================================
...
\title{知能情報総合実験 \ajroman{3}（データマイニング班） \\ 顔画像に基づく美男美女と一般人との比較による特徴抽出}
\author{215706D：KIM HYUNWOO, 235221E：山脇大輝,\\ 235701B：松田遼平, 235732B：長\UTF{7028}一生}
%\date{初版提出日: 2025年7月18日}
\date{最終提出日: \today}
\maketitle
...
\begin{itemize}
    ...
    \item 美男美女・一般人データセットに対して，ラベル付け
        ...
        \end{itemize}
    %\item ファイルのリネーム => GitHubリポジトリに詳細を記載．
\end{itemize}
...
\end{tabular}
\end{table}
% 原因：過学習（Test Accuracy で結果が出ているから問題ない．）・データのリーク（=> 原因としてわかんない）・転移学習だからわかんないよ．
% 
...
\begin{figure}[H]
  ...
  \begin{minipage}[b]{0.48\linewidth}
    \centering
    \includegraphics[width=0.5\linewidth]{white\_ex\_1.jpg}
  ...
  \begin{minipage}[b]{0.48\linewidth}
    \centering
    \includegraphics[width=0.5\linewidth]{white\_ex\_2.jpg}
...
% FairFace white paper
    ...
    In \textit{Proceedings of the IEEE/CVF Winter Conference on Applications of Computer Vision}, pages 1548--1558, 2021.\\
      ...
      \bibitem{FairFaceGitHub}FairFace(GitHub), \url{https://github.com/joojs/fairface}
    % 美男ランキング
    \bibitem{bidanshi}
  ...
  % EfficientNet
  \bibitem{efficientnet}EfficientNet: Rethinking Model Scaling for Convolutional Neural Networks., Mingxing Tan, Quoc V. Le. 
 	\url{https://arxiv.org/abs/1905.11946}, 2019
	% EfficientGitHub
  \bibitem{efficientnet_git}EfficientNet PyTorch, lukemelas,\url{https://github.com/lukemelas/EfficientNet-PyTorch}
\end{thebibliography}
